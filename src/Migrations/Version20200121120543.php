 ...
 */
final class Version20200121120543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fortune_cookie CHANGE category_id category_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fortune_cookie CHANGE category_id category_id INT DEFAULT NULL');
    }
}
