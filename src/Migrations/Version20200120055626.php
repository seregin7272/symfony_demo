 ...
 */
final class Version20200120055626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fortune_cookie (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, fortune VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, number_printed INT NOT NULL, discontinued TINYINT(1) NOT NULL, INDEX IDX_F8D8B48712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
